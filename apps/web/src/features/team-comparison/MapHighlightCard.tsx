    ...
    <Card className="flex flex-col gap-xs">
      ...
      <dl className="flex flex-col gap-2xs text-sm">
        <div className="flex items-center justify-between gap-sm">
          ...
          <dd className="flex items-center gap-2xs font-medium text-foreground">
            {strongest ? (
              <>
                <MapThumbnail mapId={strongest.mapId} />
                {strongest.mapName} · {Math.round(strongest.score)}
              </>
            ) : (
              "Not available"
            )}
        ...
        <div className="flex items-center justify-between gap-sm">
          ...
          <dd className="flex items-center gap-2xs font-medium text-foreground">
            {weakest ? (
              <>
                <MapThumbnail mapId={weakest.mapId} />
                {weakest.mapName} · {Math.round(weakest.score)}
              </>
            ) : (
              "Not available"
            )}
